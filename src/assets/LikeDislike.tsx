...
export function LikeDislike({
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M19.0808 3.71997L17.3108 2.34998C17.0808 2.11998 16.5708 2.01001 16.2208 2.01001H14.0508C13.3608 2.01001 12.6208 2.51996 12.4508 3.20996L11.0808 7.38C10.7908 8.18 11.3108 8.87 12.1708 8.87H14.4608C14.8008 8.87 15.0908 9.16006 15.0308 9.56006L14.7408 11.39C14.6308 11.9 14.9708 12.48 15.4808 12.65C15.9408 12.82 16.5108 12.59 16.7408 12.25L19.0808 8.76001"
        stroke={color}
        strokeWidth="1.5"
        strokeMiterlimit="10"
      />
      <path
        d="M22.0004 3.71997V9.31995C22.0004 10.1199 21.6604 10.41 20.8604 10.41H20.2904C19.4904 10.41 19.1504 10.1199 19.1504 9.31995V3.71997C19.1504 2.91997 19.4904 2.63 20.2904 2.63H20.8604C21.6604 2.63 22.0004 2.90997 22.0004 3.71997Z"
        stroke={color}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
